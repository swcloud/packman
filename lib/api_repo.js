      ...
      this.languages.forEach(function(l) {
        if (packager[l]) {
          var buildAPackage = function buildAPackage(next) {
            ...
            if (l === 'nodejs' && cleanName.indexOf('google-') === 0) {
              opts.packageInfo.api.name = '@google-cloud/' +
                  cleanName.replace(/^google-(cloud-)?/, '');
            } else {
            ...
            console.log('opts.packageInfo.api.simplename='+opts.packageInfo.api.simplename);
            console.log('opts.packageInfo.api.path='+opts.packageInfo.api.path);
            console.log('opts.packageInfo.api.name='+opts.packageInfo.api.name);
            console.log('opts.packageInfo.api.dependsOn='+opts.packageInfo.api.dependsOn);
            console.log('opts.packageInfo.api.titlename='+opts.packageInfo.api.titlename);
            console.log('opts.packageInfo.api.shortname='+opts.packageInfo.api.shortname);
            var semver = opts.packageInfo.api.semver[l];
            if (semver) {
              /* eslint-disable camelcase */
              opts.packageInfo.api.semantic_version = semver;
